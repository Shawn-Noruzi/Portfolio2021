                ...
                <div className="col-md-6">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      team, clients and management to meet weekly deliverables.
                      I was tasked with modernizing the UX/UI based on mock ups,
                      testing, documenting and fixing technical issues.
                    </p>
                    <Row>
                      <Col>
                        <TechText>
                    ...
                    <Row>
                      ...
                      >
                        ...
                        />
                        <Text>
                          <Link href="https://placespeak.com/">View Site</Link>
                        </Text>
                      </Row>
                    </Row>
                  </div>
              ...
              <div className="row no-gutters">
                ...
                <div className="col-md-6">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      In 2020 I worked on 'bounties' for the site GitPay and was
                      later hired as a consultant and Front End Engineer. I was
                      tasked with modernizing the UX/UI based on mock ups,
                      testing, documenting, fixing technical issues while
              ...
              <div className="row no-gutters">
                ...
                <div className="col-md-6">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      In early 2020 I joined a start up open source project with
                      4 others to create a Tinder-like matching app for software
                      developers. The goal is to create meaningful connections
                      between people starting out and those deep in the
                      industry. As a Front End Engineer I oversaw development at
                      all stages of the product life cycle and created most of
